...
?>
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" action="index.php?include=konfirmasi-edit-konten" 
      method="post" enctype="multipart/form-data">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" name="tanggal" id="nim" value="<?php echo $tgl;?>">
            </div>
          </div>
          <div class="form-group row">
