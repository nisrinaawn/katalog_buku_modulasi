...
if (isset($_SESSION['katakunci_blog'])) {
  $katakunci_kategori = $_SESSION['katakunci_blog'];
}
?>
    ...
    <section class="content">
            <div class="card">
              ...
              <div class="card-body">
              <div class="col-md-12">
                  <form method="post" action="index.php?include=kategori-blog&aksi=cari">
                    <div class="row">
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_blog; ?>?')) window.location.href = 'index.php?include=kategori-blog&aksi=hapus&data=<?php echo $id_kategori_blog;?>¬if=hapusberhasil'" 
              ...
              <div class="card-footer clearfix">
                ...
                if($jum_halaman==0){
                  ...
                  if($halaman!=1){
                    ...
                    href='index.php?include=kategori-blog&halaman=1'>First</a></li>";
                    echo "<li class='page-item'><a class='page-link' 
                    href='index.php?include=kategori-blog&halaman=$sebelum'>«</a></li>";
                  }
                  for($i=1; $i<=$jum_halaman; $i++){
                      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                        if($i!=$halaman){
                            echo "<li class='page-item'><a class='page-link' 
                            href='index.php?include=kategori-blog&halaman=$i'>$i</a></li>";
                        }else{
                  ...
                  if($halaman!=$jum_halaman){
                        echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-blog&halaman=$setelah'>»</a></li>";
                        echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-blog&halaman=$jum_halaman'>Last</a></li>";
                  }      
                }?>
                </ul>
              </div>
