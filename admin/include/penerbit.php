    ...
    <section class="content">
            <div class="card">
              ...
              <?php }?>
                ...
                <table class="table table-bordered">
                  ...
                  <?php 
                    ...
                    $sql_k .="ORDER BY `penerbit`,`alamat` limit $posisi, $batas";
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $penerbit; ?>?')) window.location.href = 'index.php?include=penerbit&aksi=hapus&data=<?php echo $id_penerbit;?>¬if=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
                    <?php $no++; }?>
                  </tbody>
              ...
              <?php
                ...
                if (isset($_GET["katakunci_penerbit"])) {
                  $katakunci_penerbit = $_GET["katakunci_penerbit"];
                  $sql_jum .= " WHERE `penerbit`, `alamat` LIKE '%$katakunci_penerbit%' ";
                }
                $sql_jum .= "order by `penerbit`, `alamat`"; 
