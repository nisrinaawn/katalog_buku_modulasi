...
?>
    ...
    <section class="content">
            <div class="card">
                  ...
                  <table class="table table-bordered">
                    ...
                    if(!isset($_GET['halaman'])){
                      ...
                      if (isset($_POST["katakunci"])){
                        ...
                        $sql_b .= " WHERE `b`.`judul` LIKE '%$katakunci_buku%' OR `k`.`kategori_buku` LIKE '%$katakunci_buku%' OR `p`.`penerbit` LIKE '%$katakunci_buku%'";
                        }
              ...
              $sql_jum = "SELECT `id_buku`, `judul` FROM `buku` ORDER BY `judul`"; 
              ...
              if($jum_halaman==0){
                //tidak ada halaman
                  ...
                  if (isset($_POST["katakunci"])){
                      $katakunci_buku = $_POST["katakunci"];
                      if($halaman!=1){
                        echo "<li class='page-item'><a class='page-link' href='index.php?include=buku&katakunci=$katakunci_buku&halaman=1'>First</a></li>";
                        echo "<li class='page-item'><a class='page-link' href='index.php?include=buku&katakunci=$katakunci_buku&halaman=$sebelum'>«</a></li>";
                      }
                      for($i=1; $i<=$jum_halaman; $i++){
                      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                        if($i!=$halaman){
                            echo "<li class='page-item'><a class='page-link' href='index.php?include=buku&katakunci=$katakunci_buku&halaman=$i'>$i</a></li>";
                        }else{
                      ...
                      if($halaman!=$jum_halaman){
                          ...
                          <a class='page-link' href='index.php?include=buku&katakunci=$katakunci_buku&halaman=$setelah'>»</a></li>";
                          echo "<li class='page-item'><a class='page-link' href='index.php?include=buku&katakunci=$katakunci_buku&halaman=$jum_halaman'>Last</a></li>";
                      }
                  }else{
                    if($halaman!=1){
